...
export function Update() {
    ...
    useEffect(() => {
        ...
        fetch("http://localhost:3012/Update/" + id + "")
    ...
    const handlesubmit = async (event) => {
        ...
        await axios.put('http://localhost:3012/updatedata/' + id + '', datastring, config)
            .then(function (res) {
                    ...
                    <table width="100%" className="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Password</td>
                                <td>
                                    <input type="password" name="pin" id="pin" value={password} onChange={(e)=>setPassword(e.target.value)} className="form-control" />
                                </td>
                            </tr>
                            <tr>
